        ...
        function verinputs(id){
            ...
            switch(id){
                ...
                case 'semis-left-0':
                        ...
                        validarinputs(id);
                        if( (!$('#semis-left-1').val()=="") && ($('#semis-left-1').val().length<=2) && (!$('#semis-left-1').val()<=10)) computar_ganador("semis-left-0","semis-left-1","final-0","3puesto-0");
                        break;
                case 'semis-left-1':
                        console.log("se cambio valores en semis-left-1");
                        validarinputs(id);
                        if( (!$('#semis-left-0').val()=="") && ($('#semis-left-0').val().length<=2) && (!$('#semis-left-0').val()<=10)) computar_ganador("semis-left-0","semis-left-1","final-0","3puesto-0");
                        break;
                case 'semis-right-0':
                        console.log("se cambio valores en semis-right-0");
                        validarinputs(id);
                        if( (!$('#semis-right-1').val()=="") && ($('#semis-right-1').val().length<=2) && (!$('#semis-right-1').val()<=10)) computar_ganador("semis-right-0","semis-right-1","final-1","3puesto-1");
                        break;
                case 'semis-right-1':
                        console.log("se cambio valores en semis-right-1");
                        validarinputs(id);
                        if( (!$('#semis-right-0').val()=="") && ($('#semis-right-0').val().length<=2) && (!$('#semis-right-0').val()<=10)) computar_ganador("semis-right-0","semis-right-1","final-1","3puesto-1");
                        break;
                case 'final-0':
        ...
        */
        function final(id_equipo1,id_equipo2){
            ...
            if ( ($('#'+id_equipo1+'').val()) > ($('#'+id_equipo2+'').val()) ){ //ganó equipo1
                ...
                document.getElementById("numero2-final-2").style.display = "inline";
                ...
                document.getElementById("numero2-final-0").style.display = "none";
                document.getElementById("numero1-final-1").style.display = "none";
                document.getElementById("numero2-final-2").style.display = "none";
            }
        }
       ...
       function tercer_puesto(id_equipo1,id_equipo2){
         ...
         * **/
        function computar_ganador(id_equipo1,id_equipo2,id_posicion1,id_posicion2){
        ...
        function pasarganador(id_input,id_posicion){
            ...
            console.log(id_span1 + "/" +id_img1);
            console.log(id_span2 + "/" +id_img2);
